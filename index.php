...
<body style="background: #DAE2F8;  /* fallback for old browsers */
...
">
  ...
  <header style="background-color: #D6A4A4;" class=" header">
    ...
    <form action="" method="POST" class="login-form">
      ...
      ?>
        ...
        <a href="editUser.php?user=<?php echo $username ?>" style="margin-right: 25px" class="btn">sửa</a>
  ...
  ?>
  <section style="background-image: url('https://wallpaperaccess.com/full/1537562.png');" class="home" id="home">
    <div class="content">
      <h3 style="color: white;"><?php echo $first_slogan ?> <span><?php echo $key_slogan ?> </span><?php echo $last_slogan ?></h3>
      <p style="color: white;"><?php echo $sub_slogan ?></p>
  ...
  <section class="categories" id="categories">
    ...
    <div class="box-container">
      ...
      ?>
        <div class="box">
          <img src="assets/img/<?php echo $row_categorie['img_categorie'] ?>" alt="" />
  ...
  <section style="background-color: #DAE2F8;" class="footer">
    <div class="box-container">
      <?php
